...
namespace ABCLearn.Hubs
{
    public class HubMetting : Hub
    {
        ...
        {
            if (!ListUserMeetingRoom.listUserRoom.ContainsKey(Context.ConnectionId))
            {
                ListUserMeetingRoom.listUserRoom.Add(Context.ConnectionId, userid);
            }
        ...
        {
            ListUserMeetingRoom.listUserRoom.Remove(Context.ConnectionId);
            Clients.All.SendAsync("user-disconnected", ListUserMeetingRoom.listUserRoom[Context.ConnectionId]);
