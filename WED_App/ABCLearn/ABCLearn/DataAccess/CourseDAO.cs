    ...
    public class CourseDAO
    {
        ...
        public bool AddNewCourse(Course course)
        {
            ...
            string query = "INSERT INTO tblCourse VALUES " +
                "( @idLecturer , @title , @detail , @price , @sale , 'True') ";
        ...
        public bool AddNewCalendar(int IDCourse, TimeSpan timeStart, TimeSpan timeEnd)
        {
            bool result = false;
            string query = "INSERT INTO tblCalendar VALUES " +
                " ( @IDCourse , @start , @end ) ";
            result = ConectionData.ExecuteUpdate(query, new object[] { IDCourse, timeStart, timeEnd });
            return result;
        }
        public bool enrollCourse(int idCourse, int idStudent)
        {
            bool result = false;
